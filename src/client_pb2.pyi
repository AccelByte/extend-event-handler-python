...
class Client(_message.Message):
    __slots__ = ("client_id", "name", "client_type", "base_uri", "redirect_uri", "secret", "audiences", "client_platform", "two_factor_enabled", "namespace")
    CLIENT_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class ClientCreateObj(_message.Message):
    __slots__ = ("client_id", "name", "client_type", "base_uri", "redirect_uri", "secret", "audiences", "client_platform", "two_factor_enabled", "namespace", "parent_namespace")
    CLIENT_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    CLIENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    BASE_URI_FIELD_NUMBER: _ClassVar[int]
...
class ClientThirdParty(_message.Message):
    __slots__ = ("platform_id", "app_id", "redirect_uri", "secret", "active")
